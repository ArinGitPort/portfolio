...
export function Profile() {
  return (
    <section className="mb-9 flex animate-[fade-in_1s_ease-out] flex-col items-center gap-4 text-center md:flex-row md:text-left" aria-labelledby="profile-heading">
      <div className="flex aspect-square size-[5rem] min-h-[5rem] min-w-[5rem] animate-[scale-in_1.2s_ease-out] items-center justify-center overflow-hidden rounded-full border-2 border-line transition-all duration-300 ease-out hover:scale-105 hover:shadow-[0_0_15px_var(--shadow)]">
